...
const styles = {
    ...
    pageContainer: { display: 'flex', justifyContent: 'center', padding: '20px' },
    mainContent: { display: 'flex', justifyContent: 'space-between', width: '80%' },
    ...
    profileContainer: { marginLeft: '220px', width: 'calc(100% - 240px)', marginTop: '50px', padding: '20px', boxShadow: '0px 0px 10px rgba(0, 0, 0, 0.1)', backgroundColor: '#fff', borderRadius: '10px' },
