# Generated by Django 5.0.6 on 2024-08-15 06:06
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.IntegerField(choices=[(1, 'User'), (2, 'Moderator'), (3, 'Admin')], default=1)),
                ('avatar', cloudinary.models.CloudinaryField(max_length=255, null=True)),
                ('cover_image', cloudinary.models.CloudinaryField(max_length=255, null=True)),
